...
-- 建立假資料 orderlist -- ok
INSERT INTO orderlist (orderListID,orderID,actID,actTotal,QRcodeID,orderListTime,reviewContent,fivestarReview,seatColumns,seatRows,vacancy) VALUES (1,1,1,500,12345678,20230909,'超好笑',5,0,1,1600);
INSERT INTO orderlist (orderListID,orderID,actID,actTotal,QRcodeID,orderListTime,reviewContent,fivestarReview,seatColumns,seatRows,vacancy) VALUES (2,2,2,2500,12444678,20230909,'超好笑',5,0,1,1600);
INSERT INTO orderlist (orderListID,orderID,actID,actTotal,QRcodeID,orderListTime,reviewContent,fivestarReview,seatColumns,seatRows,vacancy) VALUES (3,3,3,3500,123467778,20230909,'超好笑',5,0,1,1600);
